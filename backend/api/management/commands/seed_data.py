...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Все трейлеры в правильном embed формате ✅
        movies_data = [
            (
            ...
            (
                ...
                'https://www.youtube.com/embed/GTWqwSNQCcg',
            ),
            (
                'Interstellar',
            ...
            (
                ...
                'https://www.youtube.com/embed/Ur_DIHs92NM',
            ),
            (
                'The Hangover',
                ...
                'https://www.youtube.com/embed/TZc39afdeXU',
            ),
            (
                'Get Out',
            ...
            (
                ...
                'https://www.youtube.com/embed/yDJIcYE32NU',
            ),
            (
                'Avengers: Infinity War',
                'https://m.media-amazon.com/images/I/81skfhCLqZL._AC_UF1000,1000_QL80_.jpg',
                '2018-04-27', 9.0, 'Action',
                'Earth\'s heroes fight Thanos, who wants to collect all Infinity Stones.',
