...
class Movie(models.Model):
    ...
    release_date = models.DateField(null=True, blank=True)
     ...
     genre = models.ForeignKey(Genre , on_delete = models.SET_NULL, null =True , blank = True ,related_names = 'movies')
    trailer_url = models.URLField(blank=True, default='', help_text='YouTube embed URL')
